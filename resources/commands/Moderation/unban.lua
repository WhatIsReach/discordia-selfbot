return 
	{About = "Unbans a person from the guild.",
    ...
    local result = server:unbanUser(member)
		if result then
    	return command:success("Successfully unbanned **"..member.username.."**.")
		else
			return command:error("Failed to unban **"..member.username.."**.")
		end
	end